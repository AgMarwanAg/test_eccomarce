  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        inputFormatters:
            (widget.keyboardType == TextInputType.number || widget.keyboardType == TextInputType.phone) ? <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp(r'[0-9\u0660-\u0669]'))] : null,
        onChanged: widget.onChanged,
        onTap: widget.onTap,
        onFieldSubmitted: widget.onFieldSubmitted,
        onTapOutside: widget.tapOutSide ? (event) => FocusManager.instance.primaryFocus?.unfocus() : null,
